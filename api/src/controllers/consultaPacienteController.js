...
module.exports = {
    buscarTodasConsul: async (req, res) => {
        let json = { error: '', result: [] };

        try {
            // Chama a função do model para buscar todas as consultas
            const consultas = await consultaModel.buscarTodasConsul();
            ...
            json.error = 'Ocorreu um erro ao buscar as consultas.';
    ...
    criarConsulta: async (req, res) => {
        ...
        try {
            ...
            const { paci_id, ubs_id, area_id, horarios_id, estado } = req.body;

            // Chama a função do modelo para criar a consulta
            const consulta_id = await consultaModel.criarConsulta(paci_id, ubs_id, area_id, horarios_id, estado);
